namespace _08._Memory
{
    internal class Program
    {
        ...
        */
        ...
        void Main1()
        {
            int a = 1;          //지역변수 : 이 지역에서 사용하는 변수
            Stack1(a);          //지역변수는 블록안에서 생성, 블록 끝에서 소멸함
        }
        ...
        */
        ...
        static class StaticClass2
        {
            ...
            //public void NonStaticFunc() {} // error : 정적클래스에서 멤버변수를 포함할 수 없음
        ...
        void Main3()
        {
            ...
            //StasicClass.NonStaticFunc();     // error : 맴버함수는 인스턴스가 있어야 사용가능
            ...
            // instance.staticInt = 20;         // error : 정적변수는 인스턴스가 아닌 클래스 이름을 통해서 접근
            // instance.StaticFunc();           // error : 정적함수는 인스턴스가 아닌 클래스 이름을 통해서 접근
        }
        class Student
        {
